...
class BTPayPalAutoLink_Tests: XCTestCase {
    ...
    func testApplicationDidBecomeActive_whenBTGWReturns202_doesNotCompleteAndKeepsPendingStore() {
        BTPayPalClient.payPalClient = payPalClient
        mockPendingStore.storedSession = makeValidSession()
        mockAPIClient.cannedResponseBody = nonceResponseBody
    ...
    func testApplicationDidBecomeActive_whenBTGWReturns202_thenSucceedsOnNextForeground_deliversNonce() {
        BTPayPalClient.payPalClient = payPalClient
        mockPendingStore.storedSession = makeValidSession()
        mockAPIClient.cannedResponseBody = nonceResponseBody
        mockAPIClient.cannedHTTPURLResponse = makeHTTPURLResponse(statusCode: 202)
